...
final class MavenLoggingPrintStreams {

    private MavenLoggingPrintStreams() {
    }

    static PrintStream standardOut(Log log) {
        return printStream(log::info);
    }

    static PrintStream standardErr(Log log) {
        return printStream(log::warn);
    }
